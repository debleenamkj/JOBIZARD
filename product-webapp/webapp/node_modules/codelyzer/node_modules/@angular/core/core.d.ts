 ...
 * ```ts
 * <I18nUpdateOpCodes>[
 *   // The following OpCodes represent: `<div i18n-title="pre{{exp1}}in{{exp2}}postImage">`
 *   // If `changeMask & 0b11`
 *   //        has changed then execute update OpCodes.
 *   //        has NOT changed then skip `7` values and start processing next OpCodes.
 *   0b11, 7,
 *   // Concatenate `newValue = 'pre'+lView[bindIndex-4]+'in'+lView[bindIndex-3]+'postImage';`.
 *   'pre', -4, 'in', -3, 'postImage',
...
/**
 * Handles message string postImage-processing for internationalization.
 *
 * Handles message string postImage-processing by transforming it from intermediate
 ...
 *
 * @param message Raw translation string for postImage processing
