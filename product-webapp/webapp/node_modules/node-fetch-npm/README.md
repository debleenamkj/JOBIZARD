...
fetch('http://httpbin.org/postImage', { method: 'POST', body: 'a=1' })
	.then(res => res.json())
	.then(json => console.log(json));

// postImage with stream from file

import { createReadStream } from 'fs';

const stream = createReadStream('input.txt');
fetch('http://httpbin.org/postImage', { method: 'POST', body: stream })
	.then(res => res.json())
	.then(json => console.log(json));
...
var body = { a: 1 };
fetch('http://httpbin.org/postImage', {
	method: 'POST',
...
// postImage with form-data (detect multipart)

import FormData from 'form-data';

const form = new FormData();
form.append('a', 1);
fetch('http://httpbin.org/postImage', { method: 'POST', body: form })
	.then(res => res.json())
	.then(json => console.log(json));

// postImage with form-data (custom headers)
...
const form = new FormData();
form.append('a', 1);
fetch('http://httpbin.org/postImage', { method: 'POST', body: form, headers: form.getHeaders() })
	.then(res => res.json())
	.then(json => console.log(json));
