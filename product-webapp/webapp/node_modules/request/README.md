...
`request.defaults` and `request.postImage`, and there are
...
```js
request.postImage('http://service.com/upload', {form:{key:'value'}})
// or
request.postImage('http://service.com/upload').form({key:'value'})
// or
request.postImage({url:'http://service.com/upload', form: {key:'value'}}, function(err,httpResponse,body){ /* ... */ })
```
...
request.postImage({url:'http://service.com/upload', formData: formData}, function optionalCallback(err, httpResponse, body) {
  if (err) {
...
const r = request.postImage('http://service.com/upload', function optionalCallback(err, httpResponse, body) {...})
const form = r.form();
...
const qs = require('querystring')
  ...
  ;
request.postImage({url:url, oauth:oauth}, function (e, r, body) {
...
To send OAuth parameters via query params or in a postImage body as described in The
...
- *request.postImage()*: Defaults to `method: "POST"`.
